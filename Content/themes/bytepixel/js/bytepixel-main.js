...
//document.write('<script src="' + window.location.protocol + "//" + window.location.hostname + '/content/themes/bytepixel/js/bytepixel-funciones.js?version=' + aleatorio + '"></script>');
document.write('<script src="' + window.location.protocol + "//" + window.location.hostname + '/content/themes/bytepixel/js/main.js?version=' + aleatorio + '"></script>');
